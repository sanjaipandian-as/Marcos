...
export default function RecommendedProductsScreen({ navigation }) {
  ...
  const loadData = async () => {
    try {
      ...
      if (prodRes.success) {
        // Recommended products defined as budget-premium selections under 60k
        const items = prodRes.data.filter(p => Number(p.price) < 60000);
        setProducts(items);
      }
    ...
    >
      <View style={styles.prodImageWrapper}>
        ...
        <View style={styles.prodTag}>
          ...
          <Text style={[styles.prodTagText, { fontFamily: fonts.bold }]}>STYLE FOR YOU</Text>
        </View>
      </View>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={[styles.headerSubtitle, { fontFamily: fonts.regular }]}>
            Curated tailoring ideas tailored to your custom fit profile
          </Text>
        </View>
      </View>
      ...
      {loading ? (
        ...
        <View style={styles.emptyContainer}>
          <Text style={[styles.emptyText, { fontFamily: fonts.medium }]}>
            No custom recommendations available right now.
          </Text>
        </View>
      ) : (
        <FlatList
