...
async function main() {
  ...
  const subCategoriesData: Record<string, { name: string; slug: string; imageUrl: string }[]> = {
    'bespoke-suits': [
  ...
  const productsData: Record<string, Record<string, { name: string; description: string; price: number; materialInfo: string; images: string[]; bannerImage: string }[]>> = {
    'bespoke-suits': {
      'tuxedos': [
        {
