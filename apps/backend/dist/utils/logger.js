...
const format = winston_1.default.format.combine(winston_1.default.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss:ms' }), environment_js_1.isProduction
...
exports.logger = winston_1.default.createLogger({
    level: environment_js_1.isProduction ? 'info' : 'debug',
    levels,
    format,
    transports,
});
