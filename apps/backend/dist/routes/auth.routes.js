...
router.post('/refresh', rateLimit_middleware_js_1.sensitiveRateLimiter, auth_controller_js_1.AuthController.refresh);
...
router.get('/admin/loyalty/voucher-plans', auth_middleware_js_1.authenticate, (0, auth_middleware_js_1.authorize)(client_1.Role.ADMIN, client_1.Role.SUPERADMIN), voucherPlan_controller_js_1.VoucherPlanController.adminListVoucherPlans);
router.post('/admin/loyalty/voucher-plans', auth_middleware_js_1.authenticate, (0, auth_middleware_js_1.authorize)(client_1.Role.ADMIN, client_1.Role.SUPERADMIN), voucherPlan_controller_js_1.VoucherPlanController.adminCreateVoucherPlan);
router.delete('/admin/loyalty/voucher-plans/:id', auth_middleware_js_1.authenticate, (0, auth_middleware_js_1.authorize)(client_1.Role.ADMIN, client_1.Role.SUPERADMIN), voucherPlan_controller_js_1.VoucherPlanController.adminDeactivateVoucherPlan);
